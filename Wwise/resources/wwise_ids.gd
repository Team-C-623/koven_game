...
class EVENTS:
	...
	const JOURNAL_CLOSE : int = 404720619
	const JOURNAL_OPEN : int = 2919997485
	const JOURNAL_PICKUP : int = 2362228609
	...
	const SOULMOTHER_DIALOGUE : int = 3912362598
	const TAROTBURN : int = 2451853040
	const TAROTPICKUP : int = 1908595231
	const TEXT_SCROLL_TRIMMED : int = 587584267
