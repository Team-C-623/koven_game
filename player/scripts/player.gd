...
func _physics_process(delta: float) -> void:
	...
	var in_restricted_state: bool = PlayerManager.is_in_trial_room or PlayerManager.is_talking_to_old_witch or PlayerManager.is_talking_to_merga or PlayerManager.is_entering_dungeon or PlayerManager.boss_defeated
